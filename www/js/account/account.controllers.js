angular.module('IEEE.account.controllers', [])

.controller('ProfileCtrl', function($scope, user, $ionicPopover, $ionicPopup, $ionicActionSheet, $state, $cordovaSocialSharing) {
  $scope.user = user;
  ...
  $scope.invite= function () {
    ...
    $cordovaSocialSharing
      .share("Easy Create ieeemadc", "Amazing APP", null, "http://easycreate.mmae.cl");
  }
