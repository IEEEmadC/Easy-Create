angular.module('IEEE.content.controllers', [])
...
.controller('FoodContentCtrl', function($scope,$sce, $state, $rootScope, $ionicPopup, Ideas,results) {
  ...
  $scope.youtube = $scope.trustSrc = function(src) {


    return $sce.trustAsResourceUrl("https://www.youtube.com/embed/"+src.youtube_eng+"?&theme=dark&autohide=2");
  }
